...
venv\Scripts\celery.exe -A app.workers.celery_app.celery worker --loglevel=info -P solo
#Terminal 3: In another terminal, run Beat for the recovery sweep:
venv\Scripts\celery.exe -A app.workers.celery_app.celery beat --loglevel=info


celery -A app.workers.celery_app worker --loglevel=info
celery -A app.workers.celery_app worker --loglevel=info --pool=threads
# Terminal 4: Start Celery Flower
celery -A app.workers.celery_app.celery flower --port=5555

# Terminal 5: Start FastAPI
uvicorn app.main:app --reload

#For missed old pending appointments, also run Beat:
venv\Scripts\celery.exe -A app.workers.celery_app.celery beat --loglevel=info
